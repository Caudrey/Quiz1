...
// $arrProduct = [
//     ['name' => 'Qiqi', 'desc' => 'Anemo', 'rarity'=>'R', 'price' => '10.000'],
//     ['name' => 'Diluc', 'desc' => 'Pyro', 'rarity'=>'SR', 'price' => '55.000'],
//     ['name' => 'Keqing', 'desc' => 'Electro', 'rarity'=>'SSR', 'price' => '100.000'],
//     ['name' => 'Klee', 'desc' => 'Pyro', 'rarity'=>'R', 'price' => '15.000']
// ];
    ...
    public function detail($name){
        ...
        foreach ($arrProduct as $singleProduct){
            if($name == $singleProduct['name']){
                return view('productDetail', compact('singleProduct'));
            }
        }
    }
}
